    ...
    */
    ...
    async convertToPNGView() {
        ...
        try {
            ...
            const canvas = await html2canvas(div, { useCORS: true, allowTaint: true, backgroundColor: '#000', scale: 3 });
            ...
            if (container) {
                ...
                <div style="display:flex;flex-direction:column;align-items:center;gap:10px;width:100%;height:100%;padding:10px;box-sizing:border-box;">
                  <div style="color:#fff;font-size:18px;font-weight:bold;">MIMIZUKU Dual Field (2'×2')</div>
                  ...
                  <div style="color:#aaa;font-size:14px;">Left: ${this.selectedStar.ra > this.targetCoord.ra ? 'Guide' : 'Target'} | Right: ${this.selectedStar.ra > this.targetCoord.ra ? 'Target' : 'Guide'} (1'×2' each)</div>
                </div>`;
            }
